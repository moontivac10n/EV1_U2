...
namespace MercDevs_ej2.Controllers
{
    public class RecepcionequipoesController : Controller
    {
        ...
        // GET: Recepcionequipoes/EquiposRecepcionados/{clienteId}
        public async Task<IActionResult> EquiposRecepcionados(int id)
        {
            
            // Obtener el cliente correspondiente incluyendo sus recepciones de equipo
            var cliente = _context.Recepcionequipos
